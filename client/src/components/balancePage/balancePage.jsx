...
import ButtonIcons from "../../commonElements/buttonIcons";
import "./index.css"
        ...
        <Wrapper>
            <div className="balance__page">
                ...
                <div className="transactions">
                    {state.currentUser && state.currentUser.userData.transactions.map((item,i) => <Link key={i}
                        className={"transaction-nav"} to={`/transaction/${item.transactionId}`}><Transaction key={item.transactionId}
                                                                                          data={{...item}}/></Link>)}
                </div>
